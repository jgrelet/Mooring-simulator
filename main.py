...
#
        ...
        self.edit_environnement_Action = QtGui.QAction(QtGui.QIcon(
            'exit24.png'), 'Set Environnemental Conditions', self)
        self.edit_environnement_Action.triggered.connect(
            self.edit_environnement_pushButton_clicked)

        self.start_simulation_Action = QtGui.QAction(QtGui.QIcon(
        ...
        self.generate_report_Action = QtGui.QAction(
    ...
    def load_mooring_pushButton_clicked(self):
        ...
        fileName = QtGui.QFileDialog.getOpenFileName(
            self, ("Open File"), "/home", ("Mooring (*.py)"))
